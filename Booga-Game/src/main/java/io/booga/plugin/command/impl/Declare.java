    ...
    public void run(CommandSender sender, Command command, String[] args) {
        ...
        if (hasPermission(p)) {
            if (args.length > 1) {
                    ...
                    case "peace":
                        ...
                        if (mode.equalsIgnoreCase("WAR")) {
                            ...
                            if (diamondsRequired > 0 && inventoryContains(p.getInventory(), stack)) {
                                p.sendMessage("§eYou have appeased the Gods §canger§e, and they have offered you §9peace§e.");
                ...
                p.sendMessage("§eMust specify a mode of either §cwar §eor §9peace §eto proceed.");
            }
        }
    }
}
